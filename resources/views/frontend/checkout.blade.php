...
@section('content')
    ...
    <table id="cart" class="table table-hover table-condensed">
        ...
        <tbody>
            ...
            @if (session('cart'))
                ...
                <tr>
                    ...
                    <td data-th="Subtotal" class="text-center">Rp. {{ $item['price'] * $item['quantity'] }}</td>
        ...
        <tr>
            ...
            <td colspan="2" class="hidden-xs"><a href="{{ route('submitcheckout') }}" class="btn btn-danger">Finish</a></td>
