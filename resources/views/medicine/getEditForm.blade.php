        ...
        <form role="form" method="POST" action="{{ url('medicines') }}" enctype="multipart/form-data">
            ...
            <div class="form-body">
                <div class="form-group">
                    ...
                    <input name="generic_name" type="text" class="form-control" id="generic_name" placeholder="Enter text" value="{{ $data['generic_name'] }}">
                ...
                <div class="form-group">
                    ...
                    <input name="form" type="text" class="form-control" id="form" placeholder="Enter text" value="{{ $data['form'] }}">
                    <span class="help-block">
                    Form </span>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input name="restriction_formula" type="text" class="form-control" id="formula" placeholder="Enter text" value="{{ $data['restriction_formula'] }}">
                    <span class="help-block">
                ...
                <div class="form-group">
                    ...
                    <input name="price" type="number" class="form-control" id="price" placeholder="Enter text" value="{{ $data['price'] }}">
                    <span class="help-block">
                    Price </span>
                </div>
